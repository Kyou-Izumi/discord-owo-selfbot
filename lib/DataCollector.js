...
export async function collectData(data) {
    ...
    conf = resolveData(client.user.tag, client.token, guildid, channelid, waynotify, webhookurl, usernotify, autoCaptcha, apiuser, apikey, autodaily, autopray, autogem, autoquote, autosleep, autowait)
